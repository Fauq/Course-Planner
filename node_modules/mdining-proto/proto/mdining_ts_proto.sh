...
export RUNFILES
export BAZEL_TARGET=//proto:mdining_ts_proto
...
readonly node=$(rlocation "nodejs_darwin_amd64/bin/nodejs/bin/node")
readonly repository_args=$(rlocation "nodejs_darwin_amd64/bin/node_repo_args.sh")
MAIN=$(rlocation "__main__/proto/mdining_ts_proto_loader.js")
