...
goog.exportSymbol('proto.mdining.CountArray', null, global);
goog.exportSymbol('proto.mdining.FoodStat', null, global);
goog.exportSymbol('proto.mdining.StringToInt', null, global);
goog.exportSymbol('proto.mdining.SummaryStats', null, global);
/**
 ...
 * @constructor
 */
proto.mdining.CountArray = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.mdining.CountArray.repeatedFields_, null);
};
goog.inherits(proto.mdining.CountArray, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.mdining.CountArray.displayName = 'proto.mdining.CountArray';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.mdining.SummaryStats = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.mdining.SummaryStats.repeatedFields_, null);
};
goog.inherits(proto.mdining.SummaryStats, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.mdining.SummaryStats.displayName = 'proto.mdining.SummaryStats';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @const
 */
proto.mdining.CountArray.repeatedFields_ = [1];
 ...
 * @return {!Object}
 */
proto.mdining.CountArray.prototype.toObject = function(opt_includeInstance) {
  return proto.mdining.CountArray.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.mdining.CountArray} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.mdining.CountArray.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.mdining.CountArray}
 */
proto.mdining.CountArray.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.mdining.CountArray;
  return proto.mdining.CountArray.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.mdining.CountArray} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.mdining.CountArray}
 */
proto.mdining.CountArray.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.mdining.CountArray.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.mdining.CountArray.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.mdining.CountArray} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.mdining.CountArray.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 * @return {!Array<number>}
 */
proto.mdining.CountArray.prototype.getCountsList = function() {
 ...
 * @return {!proto.mdining.CountArray} returns this
 */
proto.mdining.CountArray.prototype.setCountsList = function(value) {
 ...
 * @return {!proto.mdining.CountArray} returns this
 */
proto.mdining.CountArray.prototype.addCounts = function(value, opt_index) {
 ...
 * @return {!proto.mdining.CountArray} returns this
 */
proto.mdining.CountArray.prototype.clearCountsList = function() {
 ...
 * @const
 */
proto.mdining.SummaryStats.repeatedFields_ = [1,2,3,6];
 ...
 * @return {!Object}
 */
proto.mdining.SummaryStats.prototype.toObject = function(opt_includeInstance) {
  return proto.mdining.SummaryStats.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.mdining.SummaryStats} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.mdining.SummaryStats.toObject = function(includeInstance, msg) {
  var f, obj = {
    datesList: (f = jspb.Message.getRepeatedField(msg, 1)) == null ? undefined : f,
    numuniquefoodsList: (f = jspb.Message.getRepeatedField(msg, 2)) == null ? undefined : f,
    totalfoodmealsservedList: (f = jspb.Message.getRepeatedField(msg, 3)) == null ? undefined : f,
    allergencountsMap: (f = msg.getAllergencountsMap()) ? f.toObject(includeInstance, proto.mdining.CountArray.toObject) : [],
    attributecountsMap: (f = msg.getAttributecountsMap()) ? f.toObject(includeInstance, proto.mdining.CountArray.toObject) : [],
    foodsList: (f = jspb.Message.getRepeatedField(msg, 6)) == null ? undefined : f,
    latestweekdayfoodcountsMap: (f = msg.getLatestweekdayfoodcountsMap()) ? f.toObject(includeInstance, proto.mdining.CountArray.toObject) : []
  };
 ...
 */
proto.mdining.SummaryStats.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.mdining.SummaryStats;
  return proto.mdining.SummaryStats.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.mdining.SummaryStats} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.mdining.SummaryStats}
 */
proto.mdining.SummaryStats.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    case 2:
      var value = /** @type {!Array<number>} */ (reader.readPackedInt64());
      msg.setNumuniquefoodsList(value);
      break;
    case 3:
      var value = /** @type {!Array<number>} */ (reader.readPackedInt64());
      msg.setTotalfoodmealsservedList(value);
      break;
    case 4:
      var value = msg.getAllergencountsMap();
      reader.readMessage(value, function(message, reader) {
        jspb.Map.deserializeBinary(message, reader, jspb.BinaryReader.prototype.readString, jspb.BinaryReader.prototype.readMessage, proto.mdining.CountArray.deserializeBinaryFromReader, "", new proto.mdining.CountArray());
         });
      break;
    case 5:
      var value = msg.getAttributecountsMap();
    ...
    case 6:
      ...
      break;
    case 7:
      var value = msg.getLatestweekdayfoodcountsMap();
      reader.readMessage(value, function(message, reader) {
        jspb.Map.deserializeBinary(message, reader, jspb.BinaryReader.prototype.readString, jspb.BinaryReader.prototype.readMessage, proto.mdining.CountArray.deserializeBinaryFromReader, "", new proto.mdining.CountArray());
         });
      break;
 ...
 * @return {!Uint8Array}
 */
proto.mdining.SummaryStats.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.mdining.SummaryStats.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.mdining.SummaryStats} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.mdining.SummaryStats.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  ...
  f = message.getNumuniquefoodsList();
  if (f.length > 0) {
    writer.writePackedInt64(
      2,
      f
  ...
  f = message.getTotalfoodmealsservedList();
  if (f.length > 0) {
    writer.writePackedInt64(
      3,
      f
  ...
  f = message.getAllergencountsMap(true);
  if (f && f.getLength() > 0) {
    f.serializeBinary(4, writer, jspb.BinaryWriter.prototype.writeString, jspb.BinaryWriter.prototype.writeMessage, proto.mdining.CountArray.serializeBinaryToWriter);
  }
  f = message.getAttributecountsMap(true);
  if (f && f.getLength() > 0) {
    f.serializeBinary(5, writer, jspb.BinaryWriter.prototype.writeString, jspb.BinaryWriter.prototype.writeMessage, proto.mdining.CountArray.serializeBinaryToWriter);
  }
  ...
  f = message.getLatestweekdayfoodcountsMap(true);
  if (f && f.getLength() > 0) {
    f.serializeBinary(7, writer, jspb.BinaryWriter.prototype.writeString, jspb.BinaryWriter.prototype.writeMessage, proto.mdining.CountArray.serializeBinaryToWriter);
  }
};
 ...
 * @return {!Array<string>}
 */
proto.mdining.SummaryStats.prototype.getDatesList = function() {
 ...
 * @return {!proto.mdining.SummaryStats} returns this
 */
proto.mdining.SummaryStats.prototype.setDatesList = function(value) {
  return jspb.Message.setField(this, 1, value || []);
};
 ...
 * @return {!proto.mdining.SummaryStats} returns this
 */
proto.mdining.SummaryStats.prototype.addDates = function(value, opt_index) {
  return jspb.Message.addToRepeatedField(this, 1, value, opt_index);
};
 ...
 * @return {!proto.mdining.SummaryStats} returns this
 */
proto.mdining.SummaryStats.prototype.clearDatesList = function() {
 ...
 * @return {!Array<number>}
 */
proto.mdining.SummaryStats.prototype.getNumuniquefoodsList = function() {
 ...
 * @return {!proto.mdining.SummaryStats} returns this
 */
proto.mdining.SummaryStats.prototype.setNumuniquefoodsList = function(value) {
 ...
 * @return {!proto.mdining.SummaryStats} returns this
 */
proto.mdining.SummaryStats.prototype.addNumuniquefoods = function(value, opt_index) {
 ...
 * @return {!proto.mdining.SummaryStats} returns this
 */
proto.mdining.SummaryStats.prototype.clearNumuniquefoodsList = function() {
  return this.setNumuniquefoodsList([]);
};
 ...
 * @return {!Array<number>}
 */
proto.mdining.SummaryStats.prototype.getTotalfoodmealsservedList = function() {
 ...
 * @return {!proto.mdining.SummaryStats} returns this
 */
proto.mdining.SummaryStats.prototype.setTotalfoodmealsservedList = function(value) {
 ...
 * @return {!proto.mdining.SummaryStats} returns this
 */
proto.mdining.SummaryStats.prototype.addTotalfoodmealsserved = function(value, opt_index) {
 ...
 * @return {!proto.mdining.SummaryStats} returns this
 */
proto.mdining.SummaryStats.prototype.clearTotalfoodmealsservedList = function() {
  return this.setTotalfoodmealsservedList([]);
};
 ...
 * @param {boolean=} opt_noLazyCreate Do not create the map if
 * empty, instead returning `undefined`
 * @return {!jspb.Map<string,!proto.mdining.CountArray>}
 */
proto.mdining.SummaryStats.prototype.getAllergencountsMap = function(opt_noLazyCreate) {
  return /** @type {!jspb.Map<string,!proto.mdining.CountArray>} */ (
      jspb.Message.getMapField(this, 4, opt_noLazyCreate,
      proto.mdining.CountArray));
};
 ...
 * @return {!proto.mdining.SummaryStats} returns this
 */
proto.mdining.SummaryStats.prototype.clearAllergencountsMap = function() {
  this.getAllergencountsMap().clear();
  return this;};
 ...
 * @return {!jspb.Map<string,!proto.mdining.CountArray>}
 */
proto.mdining.SummaryStats.prototype.getAttributecountsMap = function(opt_noLazyCreate) {
  return /** @type {!jspb.Map<string,!proto.mdining.CountArray>} */ (
      jspb.Message.getMapField(this, 5, opt_noLazyCreate,
      proto.mdining.CountArray));
};
 ...
 * @return {!proto.mdining.SummaryStats} returns this
 */
proto.mdining.SummaryStats.prototype.clearAttributecountsMap = function() {
  this.getAttributecountsMap().clear();
  return this;};
 ...
 * @return {!Array<string>}
 */
proto.mdining.SummaryStats.prototype.getFoodsList = function() {
 ...
 * @return {!proto.mdining.SummaryStats} returns this
 */
proto.mdining.SummaryStats.prototype.setFoodsList = function(value) {
 ...
 * @return {!proto.mdining.SummaryStats} returns this
 */
proto.mdining.SummaryStats.prototype.addFoods = function(value, opt_index) {
 ...
 * @return {!proto.mdining.SummaryStats} returns this
 */
proto.mdining.SummaryStats.prototype.clearFoodsList = function() {
 ...
 * @return {!jspb.Map<string,!proto.mdining.CountArray>}
 */
proto.mdining.SummaryStats.prototype.getLatestweekdayfoodcountsMap = function(opt_noLazyCreate) {
  return /** @type {!jspb.Map<string,!proto.mdining.CountArray>} */ (
      jspb.Message.getMapField(this, 7, opt_noLazyCreate,
      proto.mdining.CountArray));
};
 ...
 * @return {!proto.mdining.SummaryStats} returns this
 */
proto.mdining.SummaryStats.prototype.clearLatestweekdayfoodcountsMap = function() {
  this.getLatestweekdayfoodcountsMap().clear();
  return this;};
